...
const config: SiteConfig = {
  ...
  themes: {
    ...
    // All available Shiki themes for selection in the theme picker.
    // These will be bundled separately and loaded on demand when selected by the user.
    // You can add or remove themes from this list as you like.
    // include: [
    //   'andromeeda',
    //   'aurora-x',
    //   'ayu-dark',
  ...
  giscus: {
    repo: 'di3go-sona/blog-astro',
    repoId: 'R_kgDOPZlI3g',
    category: 'Q&A',
    categoryId: 'DIC_kwDOPZlI3s4C1gnG',
